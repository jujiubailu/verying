...
const api = {
	...
	applyinfos: url + "Main/Member/applyinfo",//提币
	...
	get_buysell_price: url + "Main/Order/get_unit_price",
	get_yzm_wj_code: url + "Main/Ajax/get_yzm_wj_code",
	forget: url + "Main/Member/forget",
	server: url + "Main/Index/updatever"
}
export {
	api
}